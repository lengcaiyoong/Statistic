...
CLSWR = function(s_out,s_frame, strata, variable_lvl, pn){
		   ...
		   ##Weighting Class Adjustment
		    ...
		    ##Change Identity Status To 1 & 0
		     ...
		     ##Random Group Variance
			  clsVAR <- RGVAR_CLS(s_out_clswr,s_frame, strata, variable_lvl,n)
...
CLSWR(s_out,s_frame, strata, variable_lvl,pn)