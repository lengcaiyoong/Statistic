...
#         NOT free countries tend to "PARTLY" abolish death penalty, rather than retention, which showed in the previous     
...
#         retain (0.51 - 0.63), when HDI more than 0.7, those countries prefer PARTLY abolishment (0.7).
#     This result makes more sense, since better "economy" performance should allow citizens to have more chances to 
#         understand and discuss about the issues of capital punishment, which should then take a more tolerance position.
